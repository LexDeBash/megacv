...
**iOS Developer / Автор и преподаватель курса Junior iOS-Developer**
- Разрабатывал демонстрационные и учебные приложения с чистой архитектурой и переиспользуемыми компонентами
...
- Продвигал best practices и менторил начинающих разработчиков
